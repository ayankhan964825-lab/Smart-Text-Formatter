/**
 * Disruptive Methods: Pollution-Free Society — Presentation Engine
...
(() => {
    ...
    function launchConfetti() {
        ...
        const colors = ['#30D158', '#5AC8FA', '#2997FF', '#00C9A7', '#A8E063', '#FFD60A', '#BF5AF2', '#FF375F'];
        const pieces = [];
