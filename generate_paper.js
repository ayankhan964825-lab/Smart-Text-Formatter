...
function buildFrontPage() {
    ...
    <div class="page front-page" style="page-break-after: always; text-align: center;">
        <div>
            ...
            <div class="front-title">SMART TEXT FORMATTER</div>
    ...
    for (const member of members) {
        ...
        <div class="page" style="page-break-after: always;">
            <div class="certificate">
                ...
                <div class="cert-body">
                    Certified that this project report titled <strong>"SMART TEXT FORMATTER"</strong> is the bonafide work of <strong>${member}</strong>, who carried out the project work under my supervision. Certified further, that to the best of my knowledge the work reported herein does not form part of any other project report or dissertation on the basis of which a degree or award was conferred on an earlier occasion on this or any other candidate.
                </div>
...
function buildBody() {
    ...
    body += `<p>The methodology adopted for building the Smart Text Formatter is fundamentally object-oriented. We divided the monolithic task of text processing into a strict 4-Stage Pipeline using independent JS classes strictly adhering to SOLID principles.</p>`;
...
<head>
    ...
    <title>Smart Text Formatter - Project Report</title>
    <style>${CSS}</style>
</head>
<body>
...
console.log('Successfully generated research_paper.html (Fixed to Smart Text Formatter layout matching 3.jpeg).');
